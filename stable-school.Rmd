...
Per1.9_1.10_dt <- subset(All_count_per_dt, Item %in% c("Würden Sie sagen, dass Ihr Problembewusstsein bzgl. der Kälbergesundheitssituation im Betrieb über die Teilnahme an den 'Stallschule'-Treffen gefördert wurde?", 
